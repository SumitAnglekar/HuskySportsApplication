...
<head>
    ...
    <title>Husky Sports Application Portal</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="${contextPath}">Husky Sports Application Portal</a>
            </div>
  ...
  <div class="modal-dialog">
	...
	<form:form action="${contextPath}/user/register" commandName="user"
		...
		<table>
			...
			<tr>
				<td>Role:</td>
				<td><form:radiobutton path="role" value="scout"/>Scout
					</td>
				<td><form:radiobutton path="role" value="player"/>Player
					</td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
    ...
    <div class="banner">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h2>Connect to our Application Portal</h2>
                </div>
                <div class="col-lg-6">
