...
<body>
	...
	<table class="table table-stripped">
		<c:forEach var="j" items="${appPost}">
			...
			<tr><td><a href="${contextPath}/scout/updatePostedApps.htm?ID=${j.ID}">Update</a></td></tr>
			<tr><td><a href="${contextPath}/scout/viewApplied.htm?ID=${j.ID}">View who has applied</a></td></tr>
			<tr><td><a href="${contextPath}/scout/deletePostedApp.htm?ID=${j.ID}">Delete</a></td></tr>
			<tr><td><br/></td></tr>
		</c:forEach>
	</table>
