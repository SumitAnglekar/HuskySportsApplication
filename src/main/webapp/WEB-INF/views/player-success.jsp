            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1>Hi, ${user.firstName}</h1><br />
                       <h3> <a href="${contextPath}/player/appSearch" style="color: white" >View all posted openings</a> <br /></h3>
						 <h3> <a href="${contextPath}/player/searchApplied" style="color: white" >View all applied applications</a> <br /></h3>
						 <h3> <a href="${contextPath}/player/message"  style="color: white" >Message</a> <br /></h3>
						 <h3> <a href="${contextPath}/player/messageInbox" style="color: white" >Inbox</a> <br /></h3><br /><br />
