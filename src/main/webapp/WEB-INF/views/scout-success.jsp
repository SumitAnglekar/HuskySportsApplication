            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1>Hi, ${user.firstName}</h1><br />
                       <h3> <a href="${contextPath}/scout/appPost"  style="color: white">Post New Openings</a> <br /></h3>
						 <h3> <a href="${contextPath}/scout/searchAppPost" style="color: white">View Posted Openings</a> <br /></h3>
						 <h3> <a href="${contextPath}/scout/search" style="color: white">View All Registered Players</a> <br /></h3>
						 <h3> <a href="${contextPath}/scout/messageInbox" style="color: white" >Inbox</a> <br /></h3><br /><br />
