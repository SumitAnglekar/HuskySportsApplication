...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Application Post</a>
            </div>
	...
	<table cellpadding="5" cellspacing="5">
		<c:forEach var="a" items="${apply}">
			...
			<tr><td colspan="2"><a href="${contextPath}/player/updateApplication.htm?ID=${a.ID}">Edit</a></td>
			
				<td colspan="2"><a href="${contextPath}/player/deleteApplication.htm?ID=${a.ID}">Delete</a></td>
			</tr>
